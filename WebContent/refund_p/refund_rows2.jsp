...
<html>
	...
	<body>
		...
		<% 
			...
			session.setAttribute("rows2", rows);
			String refundyn="";
			System.out.println("__________________------"+rows);
	        ...
	        if(refundyn.equals("N")){
	        	...
	        	out.print("<script> alert('환불 가능합니다');window.location.href = 'http://localhost:8080/DBairport/refund_p/refund2.html';</script>");
	        }
