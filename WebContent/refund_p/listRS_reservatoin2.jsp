<%@ page contentType="text/html;charset=euc-kr" import="java.sql.*,airport.* , java.util.Date" %>
...
<head>
  ...
  <BODY>
  <form action="refund_rows2.jsp" method="POST" >
  <br>
 	<%	
 	...
 	%>
	<H3 align = center><%=id%>님의 예약 조회</H3>
 	<%
 ...
 System.out.print("   >> rs : " + rs + "\n");	       
      ...
      <tr> 
          <p align = center><input type="submit" value="환불" >
      </form>
      </tr>
