...
<head>
  ...
  <BODY>
  <form action="assignInsert.jsp" method="POST" >
  <br>
 	<%	
 ...
 // System.out.print("   >> col value : " + (obj) + "\n");
      ...
      <tr> 
        <p align = center><input type="submit" value="배정" >
       </form>
          	<form action="assignDelete.jsp" method="POST" >
          <p align = center><input type="submit" value="배정취소" >
        </form>
      </tr>
